...
Learn more about how to help others contribute, check out the [CONTRIBUTING GUIDELINES](CONTRIBUTING.md) for repository contributors.
...
This proyect is under the MIT lincense 📄 - check out the [LICENSE](LICENSE.md) for details.
